...
public class SupportGenerateBundleAction extends SupportChildAction {

    private static final Logger LOGGER = Logger.getLogger(SupportGenerateBundleAction.class.getName());

    static final String URL = "generateSupportBundle";

    public SupportGenerateBundleAction(@NonNull SupportAction supportAction) {
        super(supportAction);
    }
    ...
    public String getDisplayName() {
        return com.cloudbees.jenkins.support.actions.Messages.SupportGenerateBundleAction_DisplayName();
    }
